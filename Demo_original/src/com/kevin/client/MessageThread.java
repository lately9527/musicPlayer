...
class MessageThread extends Thread {
	...
	// 接收消息线程的构造方法
	public MessageThread(BufferedReader reader, JTextArea textArea,DefaultListModel listModel,PrintWriter writer,Socket socket,boolean isConnected,Map<String, User> onLineUsers,JFrame frame) {
		this.reader = reader;
